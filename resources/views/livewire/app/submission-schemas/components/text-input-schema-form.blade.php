<div class="mt-8">
    ...
    <form class="space-y-12 ">
        <div class="mt-6 space-y-6 sm:mt-5 sm:space-y-5">
            ...
            <x-app.form.checkbox name="required" id="required" wire:model="required" />

            <x-app.form.label for="visible_to_voters">Visible to voters</x-app.form.label>
            <x-app.form.checkbox name="visible_to_voters" id="visible_to_voters" wire:model="visible_to_voters" />
        </div>
        <div class="flex justify-end">
            <button class="button-lesser button-regular" type="button">Close</button>
            <button class="button-lesser button-regular ml-3" type="button">Submit</button>
        </div>
    </form>
</div>
